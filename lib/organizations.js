 ...
 *
 * Opens 1 minute after close time (so list reopens for next week immediately after closing)
 * Example: Tuesday 2pm game with 12-hour preset
 *   - Closes: Tuesday 2:00am (12 hours before game)
 *   - Opens: Tuesday 2:01am (1 minute later, for next week's signups)
 *   - This gives nearly a full week (until next Tuesday 2am) for people to sign up
 */
function calculateAccessPeriod(gameDay, gameStartHour, gameStartMinute, timezone, rsvpWindowPreset = '6-hours') {
  ...
  // This creates a weekly cycle where the list reopens immediately after closing
